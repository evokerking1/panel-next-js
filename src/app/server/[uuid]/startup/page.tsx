    ...
    <div className="animate-fade-in-up px-4 pb-8 lg:px-8">
      <div className="space-y-4 mt-4">
        <div className="rounded-xl bg-neutral-50 dark:bg-neutral-800/20 border border-neutral-200 dark:border-white/5 overflow-hidden">
          <div className="px-4 py-3 border-b border-neutral-200 dark:border-white/5 flex items-center justify-between gap-3">
            <div>
          ...
          <form onSubmit={saveCommand}>
            ...
            <div className="px-4 py-3 bg-neutral-100 dark:bg-neutral-800/50 border-t border-neutral-200 dark:border-white/5">
              <button
                type="submit"
