...
const tabs: Tab[] = [
  {
    ...
    feature: null,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-5 mb-0.5 inline-flex mr-1">
  ...
  },
  {
    ...
    feature: null,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5 mb-0.5 inline-flex mr-1">
