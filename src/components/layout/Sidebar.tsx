...
export default function Sidebar() {
  ...
  const avatarSrc = user.avatar
    ...
    : `https://ui-avatars.com/api/?name=${encodeURIComponent(user.username)}&background=525252&color=fff&size=64`
    ...
    <>
      ...
      <nav className="mobile-bottom-nav lg:hidden fixed bottom-0 left-0 right-0 z-[60] bg-white/80 dark:bg-[#141414]/80 backdrop-blur-xl border-t border-neutral-200/30 dark:border-white/5">
        <ul className="flex items-center justify-around h-16">
          ...
          <li className="flex-1">
            <Link href="/account"
              className={`mobile-nav-link flex flex-col items-center justify-center h-16 gap-1 ${isActive('/account') ? 'text-neutral-900 dark:text-white' : 'text-neutral-500 dark:text-neutral-400'}`}>
